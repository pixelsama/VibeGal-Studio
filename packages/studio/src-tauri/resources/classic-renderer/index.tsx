/**
 * 经典界面风格 —— renderer v1 模板实现。
 *
 * 项目创建时可复制进 项目/renderers/classic/；之后用户或外部工具可在项目内
 * 自由改写，引擎、剧情与播放器服务保持不变。
 *
...
const appearanceDefaults = {
  ...
  "dialogueBox.borderColor": "rgba(200, 166, 106, 0.58)",
