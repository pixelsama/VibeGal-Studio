...
function navItemStyle(active: boolean): CSSProperties {
  return {
    ...
    color: active ? palette.accent : palette.menuTextSoft,
...
function noticeStyle(tone: PlayerNotice["tone"]): CSSProperties {
  const colors = tone === "error"
    ? { border: "#b85c5c", background: "rgba(184, 92, 92, 0.16)", color: "#f3c4c1" }
    : tone === "warning"
      ? { border: palette.gold, background: "rgba(216, 185, 120, 0.14)", color: "#ead7ad" }
      : { border: palette.mint, background: "rgba(111, 185, 155, 0.14)", color: "#b9dfcf" };
  return {
    display: "flex",
    alignItems: "center",
    gap: 10,
